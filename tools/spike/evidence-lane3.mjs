...
//
//   node tools/spike/evidence-lane3.mjs --compiled DIR/compiled --out DIR --actor warden
...
if (COMPARE) sheets.push({ label: `COMPARE ${COMPARE.split('/').pop()}`, compare: true, ...(await load(COMPARE)) })
