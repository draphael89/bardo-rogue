...
**Live evidence (2026-08-29, this window):** `pnpm typecheck` green. Walking the gate now puts the first wine pads on the floor as Acheron appears — the door flash is the only hold. After that lead, `slice-kite` 1–8 is 7 wins (48–54 s) and one late loss; `slice-naive` 1–8 is eight losses (16–34 s); every run home. Coming home is unarmed, rack waiting, `1 DESCENT · UNNAMED · 1 KEPT`, title asks DESCEND AGAIN. Live overall loop foundation: **76**. Human sessions: zero.
