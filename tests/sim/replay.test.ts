...
const FIXTURES = [
  { file: 'kite-full-s2.json', hash: 3474389752, check: (m: Record<string, unknown>) => expect(m.clearSeconds).not.toBeNull() },
  { file: 'naive-wave1-s3.json', hash: 585758482, check: (m: Record<string, unknown>) => expect(m.wavesCleared).toBe(1) },
