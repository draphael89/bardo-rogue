...
const FIXTURES = [
  { file: 'kite-full-s2.json', hash: 3587502839, check: (m: Record<string, unknown>) => expect(m.clearSeconds).not.toBeNull() },
  { file: 'naive-wave1-s3.json', hash: 2140121520, check: (m: Record<string, unknown>) => expect(m.wavesCleared).toBe(1) },
