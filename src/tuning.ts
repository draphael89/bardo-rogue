...
export const tuning = {
  ...
  warden: {
    ...
    windup: 36, commitLead: 8,
    slamRadius: 42, slamTicks: 4, slamDamage: 2,
    recover: 48, cooldown: 18,
    staggerTicks: 10, knockbackScale: 0.22,
    ringWindup: 32, ringRecover: 42,
    ringAttackTicks: 4, boltCount: 8,
    boltSpeed: 96, boltRadius: 3, boltLife: 84, boltDamage: 1,
    fanWindup: 30, fanRecover: 40,
    fanCount: 3, fanSpreadDeg: 44,
    fanSpeed: 118, fanLife: 96,
    fanAttackTicks: 4,
    idleTicks: 20,
  },
