...
const FIXTURES = [
  { file: 'kite-full-s2.json', hash: 687682615, check: (m: Record<string, unknown>) => expect(m.clearSeconds).not.toBeNull() },
  { file: 'naive-wave1-s3.json', hash: 1057286188, check: (m: Record<string, unknown>) => expect(m.wavesCleared).toBe(1) },
