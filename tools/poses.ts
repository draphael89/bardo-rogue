...
const POSES: Pose[] = [
  ...
  { name: 'idle-north', scenario: 'empty', run: 'hold({aimX:0,aimY:-1}, 30)' },
  { name: 'idle-south', scenario: 'empty', run: 'hold({aimX:0,aimY:1}, 30)' },
  { name: 'run-right', scenario: 'empty', run: 'hold({moveX:1,aimX:1,aimY:0}, 22)' },
  { name: 'run-north', scenario: 'empty', run: 'hold({moveY:-1,aimX:0,aimY:-1}, 22)' },
  ...
  { name: 'dodge-north-t9', scenario: 'empty', run: 'hold({dodge:true,moveY:-1,aimX:0,aimY:-1},1); hold({moveY:-1,aimX:0,aimY:-1}, 8)' },
  { name: 'dodge-south-t9', scenario: 'empty', run: 'hold({dodge:true,moveY:1,aimX:0,aimY:1},1); hold({moveY:1,aimX:0,aimY:1}, 8)' },
